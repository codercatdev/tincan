...
export const recipeIngredientsOnWrite = functions.firestore.document('users/{userId}/recipes/{recipeId}/recipeIngredients/{recipeIngredientId}').onWrite(async (change, context) => {
